...
class AuthorOutputView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            '''
            pr_list1 = [i[1] for i in the_list1]
            pr_list2 = [i[1] for i in the_list2]
            pr_list3 = [i[1] for i in the_list3]
            pr_list4 = [i[1] for i in the_list4]
            pr_list5 = [i[1] for i in the_list5]
            pr_list6 = [i[1] for i in the_list6]
